import { useGetForms } from '@/app/[lang]/(user)/(root)/dashboard/form-management/hooks/useForm';
import { useFormColumns } from '@/components/ui/columns/FormColumns';
...
import { FormList } from '@/shared/types';
...
const FormTable = () => {
  const {
    ...
    currentPage,
    hasData,
  } = useTableQuery<FormList>(useFormColumns(), useGetForms, {
